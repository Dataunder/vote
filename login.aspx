...
<body>
    <form id="form1" runat="server">
        <div class="content">
            <div id="login">
                <asp:Label ID="Label3" runat="server" Text="欢迎登录" Width="427px" Style="font-size: 50px; font-family:'Segoe UI'"></asp:Label>
                <br />
                ...
                <br />
                <asp:HyperLink ID="HyperLink1" runat="server" Style="color: white; font-family: 微软雅黑; margin-left: 160px;font-size:20px" NavigateUrl="~/register.aspx"  >没有账号？注册一个</asp:HyperLink>
                <br />
